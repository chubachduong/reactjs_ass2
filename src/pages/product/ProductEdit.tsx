...
const ProductEdit = (props: ProductEditProps) => {
  const notify = () => toast.error('tài khoản không tồn tại!', {
    position: "top-center",
    autoClose: 1500,
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-3">
            ...
            {errors.name && <span style={{color: 'red'}}>This field is required</span> || <ToastContainer/>}
        </div>
        <div className="mb-3">
        ...
        <button onClick={notify} className="btn btn-primary">Update Product</button>
        </div>
    </form>
  )
}
